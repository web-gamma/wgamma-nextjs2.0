...
function ContactPage() {
  return (
    <div className="bg-[#1a2385] w-screen md:h-screen h-autoid=contactform">
      <div className="flex justify-around items-center mx-20 md:flex-row flex-col">
        ...
        <div className="md:w-1/2 w-full md:p-10 my-10 md:my-0  flex-col">
          ...
          <div className="flex gap-20  justify-center md:justify-start ">
            <FaInstagram className="text-2xl text-white hover:text-orange-400 cursor-pointer" />
            <FaWhatsapp className="text-2xl text-white hover:text-green-500 cursor-pointer" />
            <FaYoutube className="text-2xl text-white hover:text-red-600 cursor-pointer" />
